...
<body>
    ...
    <main>
        <div id="sec01">
            <h2>상품 게시물 수정</h2>
            <h3>- 홈웨어</h3>
            <form action="/cozysleep/process/h_edit_process.php" method="POST" id="imgForm" enctype="multipart/form-data">
                ...
                ?>
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="button" onclick="location.href='/cozysleep/subpage/homewear/homewear_list.php'" value="목록" class="writebutton">
