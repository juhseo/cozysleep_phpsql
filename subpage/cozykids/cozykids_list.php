...
<body>
    <?php
        ...
        $sql = "select * from cozykids";
        $result = mysqli_query($conn, $sql);
        function showlist(){
            global $result;
            while($row = mysqli_fetch_array($result)){
                echo "<div style='width:23%; padding-bottom:80px'>";
                echo "<div><a href='/cozysleep/subpage/cozykids/cozykids_view.php?m_no={$row['m_no']}'><img src=\"/cozysleep/process/{$row['imgsrc']}\" width='100%',height='auto'></a></div>";
    ...
    <main>
        <div id="bann_img">
                <img src="/cozysleep/img/cozykids/k_hd_img.jpg" alt="배너이미지">
            </div>
                        ...
                        echo 
                            "<button 
                                style='
                                    ...
                                    margin-bottom:20px;
                                    '>
                                        <a href='/cozysleep/subpage/cozykids/cozykids_w.php'>
                                            글쓰기
                                        </a>
                                </button>";
                    }  
