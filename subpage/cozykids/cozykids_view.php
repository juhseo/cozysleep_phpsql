...
<body>
    <?php
        ...
        $sqlstr = "select * from cozykids where m_no = {$_GET['m_no']}";
    ...
    <main>
    <form action="/cozysleep/process/k_delete_process.php" method="post">
        <input type="hidden" name="m_no" value ="{$_GET['m_no']}">
            <div>
            <div id="bedd_subb">
                <p><a href="/cozysleep/main/main.php">Home</a></p>
                <p>><p>
                <p><a href="/cozysleep/subpage/cozykids/cozykids_list.php">코지키즈</a></p>
            </div>
                <div id="bedd_sub_r">
                    <?php
                        if(isset($_SESSION['userName'])){
                            ...
                            if($session1 == "관리자"){
                                echo "<form action='/cozysleep/process/k_delete_process.php' method='post'>";
                                ...
                                echo "</form>";
                                echo "<button  style='width:150px; height:30px; color:#fff; border:none; border-radius:5px; font-weight:bold; background-color:#b7a591; cursor:pointer; float:right; margin-right:5px;'class='writebutton'><a href='/cozysleep/subpage/cozykids/cozykids_edit.php?m_no={$_GET['m_no']}'>수정하기</a></button>";
                            }
                        }
                    ?>
                </div>
            ...
            <div id="b_detail">
                <div id="detail_l">
                    <!-- table img 불러오기 -->
                    <img src="/cozysleep/process/<?= $row['imgsrc']?>" alt="예시 이미지"/>
