...
<body>
    <?php
        ...
        function showlist(){
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                echo "<div><a href='/cozysleep/subpage/living/living_view.php?m_no={$row['m_no']}'><img src=\"/cozysleep/process/{$row['imgsrc']}\" width='100%',height='auto'></a></div>";
    ...
    <main>
        <div id="bann_img">
                <img src="/cozysleep/img/living/l_hd_img.jpg" alt="배너이미지">
            </div>
                        ...
                        echo 
                            "<button 
                                style='
                                    ...
                                    margin-bottom:20px;
                                    '>
                                        <a href='/cozysleep/subpage/living/living_w.php'>
                                            글쓰기
                                        </a>
                                </button>";
                    }  
