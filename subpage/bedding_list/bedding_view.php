...
<body>
    <?php
        ...
        $sqlstr = "select * from bedding where m_no = {$_GET['m_no']}";
    ...
    <main>
        <form action="/cozysleep/process/b_delete_process.php" method="post">
            ...
            <div>
                ...
                <?php
                        if(isset($_SESSION['userName'])){
                            ...
                            if($session1 == "관리자"){
                                echo "<form action='/cozysleep/process/b_delete_process.php' method='post'>";
                                ...
                                echo "</form>";
                                echo "<button  style='width:150px; height:30px; color:#fff; border:none; border-radius:5px; font-weight:bold; background-color:#b7a591; cursor:pointer; float:right; margin-right:5px;'class='writebutton'><a href='/cozysleep/subpage/bedding_list/bedding_edit.php?m_no={$_GET['m_no']}'>수정하기</a></button>";
                            }
                        }
                    ?>
                </div>
